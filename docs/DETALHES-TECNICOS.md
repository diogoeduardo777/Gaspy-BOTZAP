# Gaspy BOTZAP — Detalhes técnicos e referência

> Para o **passo a passo prático de instalação na loja**, veja o [README.md](../README.md).
> Este documento reúne a referência completa: outras formas de instalar, PIX, IA, deploy,
> estrutura do projeto e multi-tenant.
